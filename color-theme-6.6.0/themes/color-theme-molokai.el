...
(defun color-theme-molokai ()
  ...
  (color-theme-install
   '(color-theme-molokai
     ...
     (font-lock-comment-face ((t (:foreground "#5c7176" :slant italic))))
     (font-lock-comment-delimiter-face ((t (:foreground "#5c7176" :slant italic))))
     (font-lock-constant-face ((t (:foreground "#AE81FF"))))
     (font-lock-doc-face ((t (:foreground "#E6DB74" :slant italic))))
     (font-lock-function-name-face ((t (:foreground "#F92672" :slant italic :bold t))))
     ...
     (font-lock-type-face ((t (:foreground "#66D9EF" :bold t))))
     (font-lock-variable-name-face ((t (:foreground "#F92672"))))
     (font-lock-warning-face ((t (:foreground "#FFFFFF" :background "#333333" :bold t))))
     ...
     (lazy-highlight ((t (:foreground "#5c7176" :background "#000000"))))
